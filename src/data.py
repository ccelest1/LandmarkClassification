...
def get_data_loaders(
    batch_size: int = 32, valid_size: float = 0.2, num_workers: int = 1, limit: int = -1, antialias: bool = True,
):
    """
...
def visualize_one_batch(data_loaders, max_n: int = 5):
    ...
    Cnames  = os.listdir(Path(get_data_location())/'train')
    class_names = [name.split(".")[1] for name in Cnames]
